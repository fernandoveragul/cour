...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ledtAnswerFirs = QtWidgets.QLineEdit(self.adminPage)
        self.ledtAnswerFirs.setObjectName("ledtAnswerFirs")
        self.gridLayout_3.addWidget(self.ledtAnswerFirs, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnFinish, 6, 2, 1, 1)
        self.btnAddQ = QtWidgets.QPushButton(self.adminPage)
        self.btnAddQ.setObjectName("btnAddQ")
        self.gridLayout_3.addWidget(self.btnAddQ, 6, 1, 1, 1)
        ...
        self.testsPage = QtWidgets.QWidget()
        self.testsPage.setObjectName("testsPage")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.testsPage)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.line_2 = QtWidgets.QFrame(self.testsPage)
        self.line_2.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_2.setObjectName("line_2")
        self.gridLayout_4.addWidget(self.line_2, 1, 0, 1, 1)
        self.lblTextQuestion = QtWidgets.QLabel(self.testsPage)
        ...
        self.gridLayout_4.addWidget(self.lblTextQuestion, 0, 0, 1, 1)
        self.btnThirdAnswer = QtWidgets.QPushButton(self.testsPage)
        self.btnThirdAnswer.setText("")
        self.btnThirdAnswer.setObjectName("btnThirdAnswer")
        self.gridLayout_4.addWidget(self.btnThirdAnswer, 4, 0, 1, 1)
        self.btnSecondAnswer = QtWidgets.QPushButton(self.testsPage)
        self.btnSecondAnswer.setText("")
        self.btnSecondAnswer.setObjectName("btnSecondAnswer")
        self.gridLayout_4.addWidget(self.btnSecondAnswer, 3, 0, 1, 1)
        self.btnFirsAnswer = QtWidgets.QPushButton(self.testsPage)
        self.btnFirsAnswer.setText("")
        self.btnFirsAnswer.setObjectName("btnFirsAnswer")
        self.gridLayout_4.addWidget(self.btnFirsAnswer, 2, 0, 1, 1)
        self.btnFourAnswer = QtWidgets.QPushButton(self.testsPage)
        self.btnFourAnswer.setText("")
        self.btnFourAnswer.setObjectName("btnFourAnswer")
        self.gridLayout_4.addWidget(self.btnFourAnswer, 5, 0, 1, 1)
        self.stackedWidget.addWidget(self.testsPage)
